...
export default function DeleteAccountForm({ accountId, accountName, onSuccess }: DeleteAccountFormProps) {
  ...
  const handleSubmit = useCallback(
    async (formData: FormData) => {
      ...
      try {
        ...
        showNotification("fa-solid fa-circle-check", "success", "Cuenta eliminada", "La cuenta se eliminó correctamente.");
        onSuccess?.();
