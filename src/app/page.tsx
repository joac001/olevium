      ...
      {isLoading ? (
        ...
        <>
          <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            <DashboardCard
              title="Saldo ARS consolidado"
              subtitle="Cuentas en pesos"
              icon={<Wallet className="h-5 w-5 text-brand-300" />}
              value={formatCurrency(totalBalanceARS, 'ARS')}
              accent="from-brand-500/80 to-brand-700/60"
            />
            <DashboardCard
              title="Ingresos del período"
              subtitle="Incluye salarios y extras"
            ...
            <DashboardCard
              ...
              subtitle="Egresos y débitos"
              icon={<TrendingDown className="h-5 w-5 text-red-400" />}
              value={formatCurrency(-Math.abs(expensesPeriod))}
              accent="from-red-500/80 to-red-600/60"
            />
            <DashboardCard
              title="Movimientos"
              subtitle="Transacciones del período"
              icon={<BarIndicator />}
              value={`${transactionsCountPeriod}`}
              accent="from-brand-400/80 to-accent-500/60"
            />
          </section>
          ...
          <section className="grid gap-6 xl:grid-cols-3">
            <Card className="xl:col-span-2">
              <Box className="flex items-center justify-between">
                <Box>
                  <Typography variant="h2">Flujo de caja</Typography>
                  <Typography variant="body" className="text-[color:var(--text-muted)]">
                    Seguimiento de ingresos y gastos diarios
                  </Typography>
                </Box>
                <ActionButton
                  icon="fas fa-sync"
            ...
            <Card>
              <Box className="flex items-center justify-between">
                <Box>
                  <Typography variant="h2">Distribución de gastos</Typography>
                  <Typography variant="body" className="text-[color:var(--text-muted)]">
                    Top categorías de los últimos movimientos
                  </Typography>
                </Box>
              </Box>
              <div className="h-64">
              ...
              <ul className="space-y-3">
                {categorySlices.map(([category, value], index) => (
